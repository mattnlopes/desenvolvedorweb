<footer>
						...
						<div class="col-md-10">
							<div class="row row-cols">
								...
								<div class="col-md-4 col-get-in-touch">
									...
									<address class="hidden-xs"><i class="fa fa-map-marker"></i> <span>618 E. South Street, Suite 510</br> Orlando, FL 32801</span></address>
									<p class="hidden-xs"><a href="tel:1855ORLCITY"><i class="fa fa-phone"></i> 1.855.ORL.CITY</a></p>
									<div class="row-fluid  hidden-xl show-xs">
										<div class="col-xs-6">
									...
									<ul class="list-unstyled list-socials">
										...
										<li class="hidden-xl show-xs"><a href="#" id="page-up"><i class="fa fa-chevron-up"></i></a></li>
									</ul>
								</div>
							</div>
						</div>
		...
		<script src="https://kit.fontawesome.com/ae2757b210.js"></script>
