...
<html ng-app="shop">
	<head>
		...
		<!--<link rek="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css"> NÃO FUNCIONA-->
	...
	<body style="padding: 0;">
		<header>
			...
			<div id="menu-mobile-mask" class="hidden-xl show-xs"></div>
			<div id="menu-mobile" class="hidden-xl show-xs">
			...
			<div class="header-black">
				<div class="container">
					...
					<input type="search" id="input-search-mobile" class="hidden-xl show-xs" placeholder="Search...">

					<button id="btn-bars" type="button"><i class="fa fa-bars"></i></button>
					<button id="btn-search" type="button"><i class="fa fa-search"></i></button>

					<ul id="barra-times" class="float-right">
