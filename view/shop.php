...
<section  ng-controller="destaque-controller">
	<div class="container destaque-produtos-container">
		<div id="destaque-produtos" class="owl-carousel owl-theme">
			<div class="items row" ng-repeat="produto in produtos">
	...
	<div id="mais-buscados" class="container">
		<div class="container title-default-roxo">
				...
				<div class="col-md-3" ng-repeat="produto in buscados">
					<div class="box-produto-info">
						<a href="produto-{{produto.id_prod}}">
							...
							<div class="text-parecelado text-arial-cinza">{{produto.parcelas}}x de R$ {{produto.parcela}} sem juros</div>
						</a>
					</div>
				</div>
			</div>
...
<script>
	angular.module("shop", []).controller("destaque-controller", function($scope, $http){
		...
		var initCarousel = function(){
			...
			var owlDestaques = $("#destaque-produtos");
