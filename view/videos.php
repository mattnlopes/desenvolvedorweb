		...
		<section>
			<div id="call-to-action">
				<div class="container">
					...
					<div class="text-center">
						<video poster="/img/highlights.jpg" id="player" playsinline controls>
						...
						<!-- <input type="range" id="volume" min="0" max="1" step="0.001"> -->
...
<?php require_once("footer.php"); ?>
	<script scr="lib/plyr/dist/plyr.js"></script>
		<script>
		...
		<script>
			$(function(){
				...
				//plyr.setup(); ----DESNECESSÁRIO----disparando player plyr.
			});
		</script>